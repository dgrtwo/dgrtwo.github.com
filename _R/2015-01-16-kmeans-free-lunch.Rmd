...
What if the clusters have an uneven number of points- does that also break k-means clustering? Well, consider this set of clusters, of sizes `r sizes[1]`, `r sizes[2]`, `r sizes[3]`. I've generated each from a multivariate Gaussian: 
...
```{r different_sizes_kmeans, dependson = "different_sizes"}
